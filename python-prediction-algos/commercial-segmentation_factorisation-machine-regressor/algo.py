# This file is the actual code for the custom Python algorithm commercial-segmentation_factorisation-machine-regressor
...
class CustomPredictionAlgorithm(BaseCustomPredictionAlgorithm):    
    """
        Class defining the behaviour of `commercial-segmentation_factorisation-machine-regressor` algorithm:
    ...
    def __init__(self, prediction_type=None, params=None):        
        self.clf = FactorizationMachineRegressor()
